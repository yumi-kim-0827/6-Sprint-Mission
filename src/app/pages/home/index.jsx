...
export default function HomePage({ })
{
	return (
		<>
			...
			<Banner src={require("assets/images/banner_top.png")} title={["일상의 모든 물건을", "거래해 보세요"]} button={true}></Banner>
			...
			<Banner src={require("assets/images/banner_bottom.png")} title={["믿을 수 있는", "판다마켓 중고 거래"]} button={false}></Banner>
